...
def main(args):
    ...
    drawed_image = draw_detections(image, boxes_list, conf_threshold=0.5)
    cv2.imwrite("output.jpg", drawed_image)
    print(f"✅ Saved result as output.jpg with {len(boxes_list)} faces detected")
